...
const EDIT_START = 'redux-example/posts/EDIT_START';
const EDIT_STOP = 'redux-example/posts/EDIT_STOP';
const SAVE = 'redux-example/posts/SAVE';
const SAVE_SUCCESS = 'redux-example/posts/SAVE_SUCCESS';
const SAVE_FAIL = 'redux-example/posts/SAVE_FAIL';
